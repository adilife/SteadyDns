...
- Default forwarding and domain-specific forwarding
- Multi-priority load balancing within forward groups
...
- Go Embed support for frontend static files
- Development/Production dual-mode static file serving

#### Frontend (steadydns_ui)
- React-based web management panel
- User-friendly operation interface
- Upstream DNS server management
- Local resolution rule configuration
- Real-time DNS service status monitoring
...
- `v0.9.0-beta.x` - Beta testing versions
- `v0.9.0-rc.x` - Release candidate versions
